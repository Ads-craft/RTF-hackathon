...
const SignIn = () => {
    ...
    return <Fragment>
        ...
        <div className="flex flex-row justify-center h-screen items-center mx-auto" style={{maxWidth: "1140px"}}>
            ...
            <div className="flex flex-col justify-center md:h-screen px-5 md:w-1/2" style={{maxWidth: "720px", maxHeight: "580px"}}>
                ...
                <div className="mb-4 w-10/12 mx-auto" style={{width: "100%", maxWidth: "405px"}}>
                    ...
                    <p className="">Welcome to Adcraft. Sign into the platform with just one step.</p>
                </div>
                <form className="">
                    
                    <div className="w-10/12 mx-auto mt-5 relative" style={{width: "100%", maxWidth: "405px"}}>
                        {!emailIsValid && <p className="text-sm text-red-600 absolute right-0 top-3">invalid email format</p>}
                        <label htmlFor="email">Email Address</label> <br />
                        <input type="email" id="email" ref={emailRef} onChange={() => setEmailValid(true)} placeholder="example@mail.com" className="border-none outline-none mt-3 ps-2 bg-light-brown rounded-md" style={{width: "100%", maxWidth: "405px", height: "50px"}} />
                    </div>
                    ...
                    <div className="mx-auto mt-10 flex flex-row justify-center" style={{width: "100%", maxWidth: "405px"}}>
                        <button onClick={formSubmitHandler.bind(null, "")} className="border-light-pink border-2 rounded py-1 px-2 bg-light-pink text-white mx-auto transition-all duration-500 ease-in-out hover:bg-pink-400" style={{width: "100%", maxWidth: "405px", height: "50px"}}>Login</button>
                    </div>
                    ...
                    <div className="flex flex-row justify-center gap-3 mx-auto mt-10" style={{width: "100%", maxWidth: "405px"}}>
